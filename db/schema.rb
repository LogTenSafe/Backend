...
ActiveRecord::Schema[7.0].define(version: 2022_02_08_092028) do
  ...
  create_table "backups", force: :cascade do |t|
    ...
    t.index %w[user_id], name: "index_backups_on_user_id"
  end

  create_table "jwt_blacklist", force: :cascade do |t|
    t.string "jti", null: false
    t.datetime "exp", precision: nil, null: false
    t.index %w[jti], name: "index_jwt_blacklist_on_jti"
  end
